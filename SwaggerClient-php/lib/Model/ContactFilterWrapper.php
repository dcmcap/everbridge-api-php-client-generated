...
/**
 * ContactFilterWrapper Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ContactFilterWrapper implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContactFilterWrapper';
    ...
    protected static $setters = [
        ...
        'contact_filter_type' => 'setContactFilterType',
    ...
    protected static $getters = [
        ...
        'contact_filter_type' => 'getContactFilterType',
    ...
    const CONTACT_FILTER_TYPE_DATA_SCOPE = 'DataScope';
    const CONTACT_FILTER_TYPE_CONTACT_RULE = 'ContactRule';
    const STATUS_A = 'A';
    const STATUS_D = 'D';
     ...
     * @return string[]
     */
    public function getContactFilterTypeAllowableValues()
    {
        return [
            self::CONTACT_FILTER_TYPE_DATA_SCOPE,
            self::CONTACT_FILTER_TYPE_CONTACT_RULE,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['contact_filter_type'] = isset($data['contact_filter_type']) ? $data['contact_filter_type'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getContactFilterTypeAllowableValues();
        if (!is_null($this->container['contact_filter_type']) && !in_array($this->container['contact_filter_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'contact_filter_type', must be one of '%s'",
    ...
    /**
     * Gets contact_filter_type
     *
     * @return string
     */
    public function getContactFilterType()
    {
        return $this->container['contact_filter_type'];
    }

    /**
     * Sets contact_filter_type
     *
     * @param string $contact_filter_type contact_filter_type
     *
     * @return $this
     */
    public function setContactFilterType($contact_filter_type)
    {
        $allowedValues = $this->getContactFilterTypeAllowableValues();
        if (!is_null($contact_filter_type) && !in_array($contact_filter_type, $allowedValues, true)) {
        ...
        $this->container['contact_filter_type'] = $contact_filter_type;
     ...
     * Sets fill_color
     *
     * @param string $fill_color fill_color
     *
     * @return $this
     */
