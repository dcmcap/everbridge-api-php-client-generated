...
/**
 * DataPageNotificationReportLogWrapper_ Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DataPageNotificationReportLogWrapper_ implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataPage«NotificationReportLogWrapper»';
    ...
    protected static $swaggerTypes = [
        'current_page_no' => 'int',
        'data' => '\Swagger\Client\Model\NotificationReportLogWrapper[]',
        'page_size' => 'int',
        'scroll_id' => 'string',
        'start' => 'int',
        'total_count' => 'int',
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\NotificationReportLogWrapper[] $data data
     *
     * @return $this
     */
