...
/**
 * DataPageOrganizationContactAttributeWrapper_ Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DataPageOrganizationContactAttributeWrapper_ implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataPage«OrganizationContactAttributeWrapper»';
    ...
    protected static $swaggerTypes = [
        'current_page_no' => 'int',
        'data' => '\Swagger\Client\Model\OrganizationContactAttributeWrapper[]',
        'page_size' => 'int',
        'scroll_id' => 'string',
        'start' => 'int',
        'total_count' => 'int',
     ...
     * Gets data
     *
     * @return \Swagger\Client\Model\OrganizationContactAttributeWrapper[]
     */
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\OrganizationContactAttributeWrapper[] $data data
     *
     * @return $this
     */
