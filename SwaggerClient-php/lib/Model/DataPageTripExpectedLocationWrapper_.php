...
/**
 * DataPageTripExpectedLocationWrapper_ Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DataPageTripExpectedLocationWrapper_ implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataPage«TripExpectedLocationWrapper»';
    ...
    protected static $swaggerTypes = [
        'current_page_no' => 'int',
        'data' => '\Swagger\Client\Model\TripExpectedLocationWrapper[]',
        'page_size' => 'int',
        'scroll_id' => 'string',
        'start' => 'int',
        'total_count' => 'int',
     ...
     * Gets data
     *
     * @return \Swagger\Client\Model\TripExpectedLocationWrapper[]
     */
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\TripExpectedLocationWrapper[] $data data
     *
     * @return $this
     */
