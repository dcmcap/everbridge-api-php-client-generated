...
/**
 * DataPageVariableItemWrapper_ Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DataPageVariableItemWrapper_ implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataPage«VariableItemWrapper»';
    ...
    protected static $swaggerTypes = [
        'current_page_no' => 'int',
        'data' => '\Swagger\Client\Model\VariableItemWrapper[]',
        'page_size' => 'int',
        'scroll_id' => 'string',
        'start' => 'int',
        'total_count' => 'int',
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\VariableItemWrapper[] $data data
     *
     * @return $this
     */
