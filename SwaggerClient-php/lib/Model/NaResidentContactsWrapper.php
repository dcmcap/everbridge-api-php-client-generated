...
/**
 * NaResidentContactsWrapper Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NaResidentContactsWrapper implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NaResidentContactsWrapper';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['resident_ids'] = isset($data['resident_ids']) ? $data['resident_ids'] : null;
    }
     ...
     * Sets filter_ids
     *
     * @param string[] $filter_ids filter_ids
     *
     * @return $this
     */
     ...
     * @return string[]
     */
    public function getResidentIds()
    {
        return $this->container['resident_ids'];
    }

    /**
     * Sets resident_ids
     *
     * @param string[] $resident_ids resident_ids
     *
     * @return $this
     */
    public function setResidentIds($resident_ids)
    {
        $this->container['resident_ids'] = $resident_ids;
